...
class LM:
    def __init__(
        ...
        api_key: str=os.environ.get("VAGENTS_LM_API_KEY", ""),
    ):
        self.name = name
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        future1 = lm(messages=[{"role": "user", "content": "Hello, how are you?"}])
        future2 = lm(messages=[{"role": "user", "content": "Hello, how are you doing?"}])
        future3 = lm(messages=[{"role": "user", "content": "Hello, write a long story about alan turing?"}])
